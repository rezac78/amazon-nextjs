...
export default function RegisterPage() {
 ...
 const handleRegister = async (e: React.FormEvent) => {
  ...
  try {
   ...
   if (result?.success) {
    ...
    // optionally: انتقال به صفحه ورود
    // router.push("/login");
   } else {
 ...
 return (
  <div className=" w-[25%] mx-auto flex items-center justify-center p-4">
   <div className="bg-white w-full rounded-xl shadow-md p-6">
    <h2 className="text-2xl font-semibold text-center text-gray-800 mb-6">ثبت‌نام</h2>
    <form onSubmit={handleRegister} className="space-y-4">
     <div className="">
      ...
      <Input
       ...
       className="w-full px-3 py-2 border rounded-md bg-gray-100 mt-2"
      />
