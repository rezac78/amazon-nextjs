...
export default function ProductCard({ products, homePage }: ProductCardProps) {
        ...
        return (
                <div className="my-10">
                        <div
                                className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 px-2 md:px-6 ${homePage && ""
                                        }`}
                        >
                                {products.map((card) => {
                                                        ...
                                                        <Card className="group relative flex flex-col justify-between bg-background border border-border min-h-[420px]">
                                                                ...
                                                                <CardAction className="absolute top-40 right-4 flex flex-col border rounded-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                                                        <div
                                                                                ...
                                                                                className={`transition duration-300 ease-in-out transform hover:bg-secondary hover:text-white ${isFavorite ? "text-red-500" : "text-black"
                                                                                        }`}
                                                                        >
                                                                        ...
                                                                        <div
                                                                                ...
                                                                                className={`transition duration-300 transform hover:bg-secondary hover:text-white ${isInCart ? "text-green-500" : "text-black"
                                                                                        }`}
                                                                        >
